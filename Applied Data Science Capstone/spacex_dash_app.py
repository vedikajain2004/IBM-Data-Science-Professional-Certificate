...
l = [{'label': 'All Sites', 'value': 'ALL'}]
for s in spacex_df['Launch Site']:
    if {'label': s, 'value': s} not in l:
        l.append({'label': s, 'value': s})
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options=l, value='ALL', placeholder='Select a Launch Site here', searchable=True),
                                html.Br(),
